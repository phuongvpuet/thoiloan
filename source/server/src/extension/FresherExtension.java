...
import service.TrainingHandler;
import service.UserHandler;

import service.UserMapHandler;
...
public class FresherExtension extends BZExtension {
    ...
    public void init() {
        ...
        addRequestHandler(UserMapHandler.USER_MAP_MULTI_IDS, UserMapHandler.class);
        addRequestHandler(TrainingHandler.TRAINING_MULTI_IDS, TrainingHandler.class);
    ...
    private UserInfo getUserInfo(String username, int userId, String ipAddress) throws Exception {
        ...
        switch(customLogin){
            ...
            case 2: // set direct userid
                return GuestLogin.setInfo(userId, "Team3_User_" + userId);
