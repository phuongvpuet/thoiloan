...
public class ServerConstant {
    ...
    public static final String USER_MAP_DATA = "user_map_data";
    public static final String USER_TROOP_DATA = "user_troop_data";
    public static final String USER_LOGICAL_MAP = "user_logical_map";
